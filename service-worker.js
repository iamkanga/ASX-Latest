...
self.addEventListener('install', (event) => {
    ...
    event.waitUntil(
        caches.open(CACHE_NAME)
            ...
            .catch(error => {
                console.error('Service Worker v54: Failed to cache essential assets during install:', error); // Log specific error
            })
    );
});

self.addEventListener('activate', (event) => {
    console.log('Service Worker v54: Activating...'); // Updated log
    event.waitUntil(
    ...
    console.log('Service Worker v54: Activated and claimed clients.'); // Updated log
});
